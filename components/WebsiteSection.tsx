    ...
    case 'hero':
      return (
        <section className="bg-titan-950 text-white text-center py-20 md:py-32 px-6">
          <h1 className="text-4xl md:text-6xl font-bold mb-4" style={{ color: props.accentColor }}>
    ...
    default:
      return (
        <div className="p-8 border-b border-titan-800 bg-titan-900 text-slate-200">
          <h2 className="text-2xl font-bold">{section.content.title || `Unknown Section: ${section.type}`}</h2>
