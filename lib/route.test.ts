...
describe('Dashboard API Route', () => {
  it('should return dashboard data for an authenticated user', async () => {
    ...
    const mockProjects: Project[] = [
      { id: 'proj-1', name: 'Project Alpha', description: '', imageUrl: '', tags: [], status: 'active', created_at: new Date().toISOString(), user_id: 'user-123' },
      { id: 'proj-2', name: 'Project Beta', description: '', imageUrl: '', tags: [], status: 'inactive', created_at: new Date().toISOString(), user_id: 'user-123' },
    ];
